        ...
        <header className = "header">
            <Container className="themed-container" fluid={true}>
                <Row>
                    ...
                    <Col xl = "5">
                        <h1 align = "center" style = {{ paddingTop:"1.4rem", fontFamily:"sans-serif", fontSize: "3rem"}}>E-Lost and found portal</h1>
                    </Col>
                    ...
                    <Nav style = {{fontSize: "1.5em", color:"white", paddingTop:"2rem", paddingLeft:"4rem"}}>
                        ...
                        <NavItem>
                        <NavLink href="/signup" style = {{color:"white"}}><i className="fa fa-phone" aria-hidden="true"></i>Signup</NavLink>
                        </NavItem>
                        <NavItem>
